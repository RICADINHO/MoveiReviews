...
// Filmes lançados em 2023
$randomMovieUrl = "https://api.themoviedb.org/3/discover/movie?api_key=$apiKey&primary_release_year=2023";
$randomMovieResponse = requestAPI($randomMovieUrl);
$randomMovieData = json_decode($randomMovieResponse, true);

$rmov = $randomMovieData['results'];

foreach($rmov as $movie){
    $movieid = $movie['id'];
    array_push($ids2,$movieid);
    //echo "Movie Title: " . $movie['title'] . "<br>";
    //echo "Movie ID: " . $movie['id'] . "<br>";
    //echo "Overview: " . $movie['overview'] . "<br>";
    //echo "release date: ".$movie['release_date']."<br><br>";
